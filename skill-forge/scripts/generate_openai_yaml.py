#!/usr/bin/env python3
# Adapted from OpenAI's codex-skill-creator (upstream has no explicit license).
# Included here in good faith with attribution; please refer to the upstream
# project if you need formal licensing clarity.
"""
